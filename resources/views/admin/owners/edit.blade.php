<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <div class="text-red-400">オーナー編集</div>
        </h2>
    </x-slot>
                              ...
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                  ...
                                  <div class="w-full bg-gray-100 bg-opacity-50 rounded  focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    {{is_null($owner->shop->name) ? '-' : $owner->shop->name}}
                                  </div>
                                </div>
                              </div>
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                  <label for="create_at" class="leading-7 text-sm text-gray-600">登録日</label>
                                  <div class="w-full bg-gray-100 bg-opacity-50 rounded  focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    {{($owner->shop->created_at)->format('Y年m月d日 H時i分s秒');}}
                                  </div>
                                </div>
                              </div>
                              <div class="p-2 w-1/2 mx-auto">
